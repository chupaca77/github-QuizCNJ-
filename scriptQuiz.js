export const quiz_montegolri = {
    questions: [
      ...
      {
        text: "Laquelle de ces anecdotes sur l'IA est véridique ?",
        options: [
          "Une IA est devenue farouchement néo-nazie en moins de 24h sur Twitter",
          "Une IA a gouverné la Belgique pendant deux mois suite à une crise parlementaire",
          "Une IA a enfin tranché le débat sur la pizza ananas (spoiler alert : c'est dégueulasse)",
          "Une IA a créé Elon Musk"
        ],
        correct_answer: 1
      },
      {
      ...
      
      {
        ...
        options: [
          ...
          "On sait pas, ça reste un mystère mais on a des équipes sur le coup…"
        ],
        correct_answer: 4
      },
      ...
      
      {
        ...
        options: [
          ...
          "Jusqu'aux genoux",
          "Jusqu'à Rabat, Maroc",
          "Légende urbaine, il n'a jamais eu de dreads"
        ],
        correct_answer: 2
      }, 
    ]
